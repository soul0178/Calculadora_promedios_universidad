...
function saveState(){
  ...
  // Si js/cloud-sync.js está cargado y hay sesión iniciada, programa una
  // subida a Firestore. Si no, esta función no existe y no pasa nada: la
  // app sigue funcionando 100% local, como siempre.
...
/* ============================= TEMA (oscuro/claro) ============================= */
const THEME_KEY = 'libreta-notas-theme';
...
function setTheme(theme){
  ...
  if(meta) meta.setAttribute('content', theme==='light' ? '#f2efe4' : '#132019');
}
